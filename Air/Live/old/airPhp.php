...
<html>
  ...
  <meta name="apple-mobile-web-app-capable" content="yes" />
	...
	<audio id="audOne"  preload="auto">
			<source src="AirAudio/boop.mp3"></source>
			<!--<source src="audio/one.ogg"></source>-->
			<source src="AirAudio/one.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>	

	
	<audio id="audTwo"  preload="auto">
			<source src="AirAudio/two.mp3"></source>
			<!--<source src="audio/two.ogg"></source>-->
			<source src="AirAudio/two.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>
	
	<audio id="audThree" preload="auto">
			<source src="AirAudio/three.mp3"></source>
			<!--<source src="audio/three.ogg"></source>-->
			<source src="AirAudio/three.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>

	<audio id="audFour" preload="auto">
			<source src="AirAudio/four.mp3"></source>
			<!--<source src="audio/four.ogg"></source>-->
			<source src="AirAudio/four.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>
	
	<audio id="audFive" preload="auto">
			<source src="AirAudio/five.mp3"></source>
			<!--<source src="audio/five.ogg"></source>-->
			<source src="AirAudio/five.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>
	
	<audio id="audSix" preload="auto">
			<source src="AirAudio/six.mp3"></source>
			<!--<source src="audio/six.ogg"></source>-->
			<source src="AirAudio/six.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>	
	
	<audio id="audSeven" preload="auto">
			<source src="AirAudio/seven.mp3"></source>
			<!--<source src="audio/six.ogg"></source>-->
			<source src="AirAudio/seven.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>		

	<audio id="audEight" preload="auto">
			<source src="AirAudio/eight.mp3"></source>
			<!--<source src="audio/six.ogg"></source>-->
			<source src="AirAudio/eight.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>	

	<audio id="audNine" preload="auto">
			<source src="AirAudio/nine.mp3"></source>
			<!--<source src="audio/six.ogg"></source>-->
			<source src="AirAudio/nine.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>	
	
	<audio id="audTen" preload="auto">
			<source src="AirAudio/ten.mp3"></source>
			<!--<source src="audio/ten.ogg"></source>-->
			<source src="AirAudio/ten.wav"></source>
			Sorry, your browser does not support HTML5 audio!
	</audio>	
    <style>
      body {
...
document.write("<br /> average : " + average);
      ...
      function draw(images) {
		...
		Xposition[0]=stage.getWidth()/10-60;
		Xposition[1]=stage.getWidth()/5-60;		
		Xposition[2]=stage.getWidth()/10*3-60;
		Xposition[3]=stage.getWidth()/5*2-60;
		Xposition[4]=stage.getWidth()/2-60;
		Xposition[5]=stage.getWidth()/5*3-60;
		Xposition[6]=stage.getWidth()/10*7-60;
		Xposition[7]=stage.getWidth()/5*4-60;
		Xposition[8]=stage.getWidth()/10*9-60;		
		Xposition[9]=stage.getWidth()-60;		
        ...
        for(i=0; i<10; i++){
            ...
            cloud[i]=createCloud(Xposition[i], Yposition[posY], 30);
            ring[i]=createRing(Xposition[i], Yposition[posY], 35);            
            }
