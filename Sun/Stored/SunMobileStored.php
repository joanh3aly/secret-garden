...
if(pArrayTotal>2000){
	for(i=0; i<percentageArray.length; i++){
		percentageArray[i]=Math.floor(percentageArray[i]/1.5);
		}
	}

if(pArrayTotal>1500){
	for(i=0; i<percentageArray.length; i++){
		percentageArray[i]=Math.floor(percentageArray[i]/1.1);
		}
	}

if(pArrayTotal<1000){
	for(i=0; i<percentageArray.length; i++){
		percentageArray[i]=Math.floor(percentageArray[i]*2);
		}	
	}
...
function audioPlay(audio){
	...
	audio.play();
      ...
      function draw(images) {
		...
		circle1.on("touchstart touchmove", function() {
          this.setAlpha(1);
        ...
        circle2.on("touchstart touchmove", function() {
          this.setAlpha(1);
		...
		circle3.on("touchstart touchmove", function() {
          this.setAlpha(1);
        ...
        circle4.on("touchstart touchmove", function() {
          this.setAlpha(1);
        ...
        circle5.on("touchstart touchmove", function() {
          this.setAlpha(1);
        ...
        circle6.on("touchstart touchmove", function() {
          this.setAlpha(1);
