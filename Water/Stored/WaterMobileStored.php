...
try {
    ...
    $sql = "SELECT humidity FROM ProcTest";
...
for (var i=0; i<10; i++){
	percentageArray[i] = dataArray[i+30];
...
for(var i=0; i<10; i++){
	...
	percentageArray[i]=parseInt(useArray[i]*100-30);
